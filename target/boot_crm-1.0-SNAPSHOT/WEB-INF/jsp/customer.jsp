...
<head>
	...
	<!-- 引入css样式文件 -->
	<!-- Bootstrap Core CSS -->
	<link src="<%=basePath%>css/bootstrap.min.css"/>
	<!-- MetisMenu CSS -->
	<link src="<%=basePath%>css/metisMenu.min.css"/>
	<!-- DataTables CSS -->
	<link src="<%=basePath%>css/dataTables.bootstrap.css"/>
	<!-- Custom CSS -->
	<link src="<%=basePath%>css/sb-admin-2.css"/>
	<!-- Custom Fonts -->
	<link src="<%=basePath%>css/font-awesome.min.css" type="text/css" />
	<link src="<%=basePath%>css/boot-crm.css" type="text/css" />
</head>
<body>
<div id="wrapper">
  <!-- 导航栏部分 -->
